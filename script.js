...
class App {
  ...
  constructor() {
    ...
    document
      ...
      .addEventListener('click', this._clearAllWorkouts.bind(this));
  ...
  _clearAllWorkouts() {
    ...
    // Clear the displayed list of workouts
  ...
  _showAllWorkouts() {
    const group = this.#workouts.map(workout => L.latLng(workout.coords));
